...
Shell:     bash
Theme:     KuroBlack (custom)
Uptime:    studying since day one
...
- **Pharmacy Management System** — Java + JDBC + MySQL. Inventory, sales, and reporting management. _(in progress)_ · [view repo](https://github.com/KuroDarck/Pharmacy_System)
